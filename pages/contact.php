...
<section class="contact section" id="contact">
    ...
    <h2 class="section__title"><?= $tr['contact_me'] ?></h2>
    ...
    <div class="contact__container container grid">
        ...
        <form action="php/contact_form.php" method="POST" class="contact__form" id="contact-form">
            ...
            <div class="contact__form-div">
                <label class="contact__form-tag"><?= $tr['name_label'] ?? 'Nom' ?></label>
                <input type="text" name="Nom" required placeholder="<?= $tr['enter_name'] ?? 'Entrez votre nom' ?>" class="contact__form-input">
            </div>

            <div class="contact__form-div">
                <label class="contact__form-tag"><?= $tr['email'] ?? 'Email' ?></label>
                <input type="email" name="Email" required placeholder="<?= $tr['enter_email'] ?? 'Entrez votre email' ?>" class="contact__form-input">
            </div>

            <div class="contact__form-div contact__form-area">
                <label class="contact__form-tag"><?= $tr['message_label'] ?? 'Message' ?></label>
                <textarea name="besoin" required placeholder="<?= $tr['enter_message'] ?? 'Entrez votre message' ?>" class="contact__form-input"></textarea>
            </div>

            <p class="contact__message" id="contact-message"></p>

            <button type="submit" class="button">
                <?= $tr['send'] ?? 'Envoyer' ?> <i class="ri-send-plane-fill"></i>
            </button>
        </form>
    </div>
</section>